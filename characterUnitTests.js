var unitTest = {
	...
	testCharacter: function(charact)
	{
		...
		function checkExperience(name, expectedExperience, actualExperience)
		{
			if(actualExperience !== expectedExperience)
			{
				console.log("FAIL: character " + name + "'s experience should be " + expectedExperience + " but appears to be " + actualExperience);
			}
		}
		...
		function testLevelCorrect(adventurer, secondLevel, thirdLevel) 
		{
			...
			checkExperience(adventurer.name, 0, adventurer.experience);
			...
			checkExperience(adventurer.name, secondLevelMinusOne, adventurer.experience);	
			checkLevel(adventurer, 1, adventurer.currentLevel);
			
			//add 1 more experience so total equals amount for 2nd level
			adventurer.gainExperience(1);			
			checkExperience(adventurer.name, secondLevel, adventurer.experience);	
			...
			checkExperience(adventurer.name, thirdLevelMinusOne, adventurer.experience);	
			checkLevel(adventurer, 2, adventurer.currentLevel);
			
			//add 1 more experience so total equals amount for 3rd level
			adventurer.gainExperience(1);
			checkExperience(adventurer.name, thirdLevel, adventurer.experience);	
		...
		checkNoOfHandsFree(charact, 2, charact.noOfHandsFree);
